            ...
            <div class="card-body">
                ...
                <div class="row g-3 ">
                    <div class="mb-3">
                        ...
                        <input type="text" id="" class="form-control" placeholder="{{ $pengajuan->nim_mahasiswa }}">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Nama Mahasiswa</label>
                        <input type="text" id="" class="form-control" placeholder="{{ $pengajuan->nama_mahasiswa }}">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Tanggal Lahir</label>
                        <input type="text" id="" class="form-control" placeholder="{{ $pengajuan->tanggallahir_mahasiswa }}">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Tempat Lahir</label>
                        <input type="text" id="" class="form-control" placeholder="{{ $pengajuan->tempatlahir_mahasiswa }}">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label"> HP Mahasiswa</label>
                        <input type="text" id="" class="form-control" placeholder="{{ $pengajuan->hp_mahasiswa }}">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Email Mahasiswa</label>
                        <input type="text" id="" class="form-control" placeholder="{{ $pengajuan->email_mahasiswa }}">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Alamat Mahasiswa</label>
                        <input type="text" id="" class="form-control" placeholder="{{ $pengajuan->alamat_mahasiswa }}">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Asal Kampus</label>
                        <input type="text" id="" class="form-control" placeholder="{{ $pengajuan->asal_kampus }}">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">File Surat Permohonan</label>
                        <input type="text" id="" class="form-control" placeholder="{{ $pengajuan->file_suratpermohonan }}">
                    </div>
                    <div class="text-end">
